...
#sbatch run_GLMs_assume_NSD.sh 4 10
#sbatch run_GLMs_optimize_NSD.sh 4 10
...
#     for ((i=1;i<=NSES;i++)); do
#         sbatch run_GLMs_assume_NSD.sh $s $i
#     done
...
for ((s=4;s<=8;s++)); do
    ...
    for ((i=1;i<=NSES;i++)); do
        sbatch run_GLMs_optimize_NSD.sh $s $i
    done
...
# sbatch run_GLMs_optimize.sh CSI1 4
# sbatch run_GLMs_optimize.sh CSI1 5
# sbatch run_GLMs_optimize.sh CSI1 6
# sbatch run_GLMs_optimize.sh CSI1 7
# sbatch run_GLMs_optimize.sh CSI1 8
...
# sbatch run_GLMs_optimize.sh CSI2 2 
# sbatch run_GLMs_optimize.sh CSI2 3
# sbatch run_GLMs_optimize.sh CSI2 4
# sbatch run_GLMs_optimize.sh CSI2 5
# sbatch run_GLMs_optimize.sh CSI2 6
# sbatch run_GLMs_optimize.sh CSI2 7
# sbatch run_GLMs_optimize.sh CSI12 8
# sbatch run_GLMs_optimize.sh CSI1 9
# sbatch run_GLMs_optimize.sh CSI1 10
# sbatch run_GLMs_optimize.sh CSI1 15
